// filepath: /Users/kotlinandnode/seungho/daewoo/hotelReservation/frontend/src/views/PubliShing/register/RegisterLayout.vue
...
const goToStep = (step: string) => {
  ...
  switch (step) {
    ...
    case '2':
      ...
      break;
    case '3':
      router.push({ path: '/publishing/register/images', query: baseQuery });
      break;
    case '4':
    ...
    case '5':
      ...
      break;
    case '6':
      router.push({ path: '/publishing/register/pricing', query: baseQuery });
      break;
    case '7':
