      ...
      <div class="w-64 bg-white shadow rounded-lg p-4 flex flex-col gap-8">
        ...
        <div class="flex flex-col">
          ...
          <div class="flex flex-col gap-1 text-sm">
            <label><input type="checkbox" value="아파트" v-model="selectedCategories" @change="updateFilters" /> 아파트</label>
            <label><input type="checkbox" value="호텔" v-model="selectedCategories" @change="updateFilters" /> 호텔</label>
            <label><input type="checkbox" value="리조트" v-model="selectedCategories" @change="updateFilters" /> 리조트</label>
            <label><input type="checkbox" value="게스트하우스" v-model="selectedCategories" @change="updateFilters" /> 게스트하우스 / 비앤비</label>
            <label><input type="checkbox" value="모텔" v-model="selectedCategories" @change="updateFilters" /> 모텔</label>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          ...
          <div class="flex flex-col gap-1 text-sm">
            <label><input type="radio" name="rating" value="5" v-model="selectedRating" @change="updateFilters" /> 5+ 최고</label>
            <label><input type="radio" name="rating" value="4" v-model="selectedRating" @change="updateFilters" /> 4+ 우수</label>
            <label><input type="radio" name="rating" value="3" v-model="selectedRating" @change="updateFilters" /> 3+ 양호</label>
            <label><input type="radio" name="rating" value="2" v-model="selectedRating" @change="updateFilters" /> 2+ 낮음</label>
            <label><input type="radio" name="rating" value="1" v-model="selectedRating" @change="updateFilters" /> 1+ 최악</label>
            <label><input type="radio" name="rating" value="" v-model="selectedRating" @change="updateFilters" /> 상관없음</label>
          </div>
        </div>
      </div>
